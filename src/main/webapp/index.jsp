<html>
<body>
	<h1 style="color: violet; font-size: 40px;" align="center">HEY EVERYONE, WE DEPLOYED OUR CODE SUCCESSFULLY IN TOMCAT WEBSERVER,sandeep kola</h1>
	<h2>hai i deplyed paytm application in tomcat server.</h2>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-link" id="navItem2" href="#exploreMenu">Explore Menu</a>
                    <a class="nav-link" id="navItem3" href="#deliveryPayment">Delivery & Payment</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="wcu-section-description">We use both original recipes and classic versions of famous food items.</p>
                </div>
                <div class="col-12 col-md-4">
                    <div class="wcu-card p-3 mb-3">
                        ...
                        <p class="wcu-card-description">Experience fine dinning at the comfort of your home.All our orders are
                            carefully packed and arranged to give you the
                            nothing less than perfect.</p>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="wcu-card p-3 mb-3">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="shadow menu-item-card p-3 mb-3">
                        ...
                        <a href="" class="menu-item-link">View All<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="#d0b200" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="shadow menu-item-card p-3 mb-3">
                        ...
                        <h1 class="menu-card-title">Fish & Seafood</h1>
                        <a href="" class="menu-item-link">View All<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="#d0b200" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
                            </svg></a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h1 class="footer-section-mail-id">sandeepkola@foodmunch.com</h1>
                    <p class="footer-section-address">
                        451/5 Skd Nagar, Hyderabad, India.
                    </p>
                </div>
            </div>
        </div>
